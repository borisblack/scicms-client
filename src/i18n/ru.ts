...
const ru = {
    translation: {
        'A comment line starts with a # character': 'Строка комментария начинается с символа #',
        ...
        'Cancel': 'Отмена',
        'Cells are named after the field name in the row': 'Ячейки именуются по имени поля в строке',
        ...
        'Empty lines and whitespaces are ignored': 'Пустые строки и пробелы игнорируются',
        'Enabled': 'Включен',
        'End': 'Окончание',
        ...
        'The new rule starts on a new line': 'Новое правило начинается с новой строки',
        ...
        'You can select the entire row using an asterisk': 'Можно выбрать всю строку, используя звездочку',
