...
const ru = {
    translation: {
        ...
        'Labels': 'Метки',
        'Last %d minutes': 'Последние %d минут(ы)',
        'Last hour': 'Последний час',
        'Last %d hours': 'Последние %d часа(ов)',
        'Last day': 'Последний день',
        'Last %d days': 'Последние %d дня',
        'Last week': 'Последняя неделя',
        'Last %d weeks': 'Последние %d недели',
        'Last month': 'Последний месяц',
        'Last %d months': 'Последние %d месяца(ев)',
