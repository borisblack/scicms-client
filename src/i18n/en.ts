...
const en = {
  translation: {
    ...
    Filtered: 'Filtered',
    Filters: 'Filters',
    'First line is a heading': 'First line is a heading',
    Format: 'Format',
    Formula: 'Formula',
    ...
    No: 'No',
    'No available parameters': 'No available parameters',
    ...
    Promote: 'Promote',
    Promotion: 'Promotion',
    'Promotion error': 'Promotion error',
    ...
    Security: 'Security',
    Select: 'Select',
    'Select attributes from template': 'Select attributes from template',
