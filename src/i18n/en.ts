...
const en = {
    translation: {
        'A comment line starts with a # character': 'A comment line starts with a # character',
        ...
        'Cancel': 'Cancel',
        'Cells are named after the field name in the row': 'Cells are named after the field name in the row',
        'Checksum': 'Checksum',
        'Clear': 'Clear',
        ...
        'Empty lines and whitespaces are ignored': 'Empty lines and whitespaces are ignored',
        'Enabled': 'Enabled',
        'End': 'End',
        ...
        'The new rule starts on a new line': 'The new rule starts on a new line',
        ...
        'You can select the entire row using an asterisk': 'You can select the entire row using an asterisk',
