...
export const secondsBeforeNow: CustomFunction = {
  id: 'secondsBeforeNow',
  category: TEMPORAL_CATEGORY,
  exec: (seconds: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).minus({seconds}).toISO(),
...
export const minutesBeforeNow: CustomFunction = {
  id: 'minutesBeforeNow',
  category: TEMPORAL_CATEGORY,
  exec: (minutes: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).minus({minutes}).toISO(),
...
export const hoursBeforeNow: CustomFunction = {
  id: 'hoursBeforeNow',
  category: TEMPORAL_CATEGORY,
  exec: (hours: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).minus({hours}).toISO(),
...
export const daysBeforeNow: CustomFunction = {
  id: 'daysBeforeNow',
  category: TEMPORAL_CATEGORY,
  exec: (days: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).minus({days}).toISO(),
...
export const weeksBeforeNow: CustomFunction = {
  id: 'weeksBeforeNow',
  category: TEMPORAL_CATEGORY,
  exec: (weeks: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).minus({weeks}).toISO(),
...
export const weeksBeforeNowTrunc: CustomFunction = {
  ...
  category: TEMPORAL_CATEGORY,
  exec: (weeks: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).minus({weeks}).startOf('day').toISO(),
...
export const monthsBeforeNow: CustomFunction = {
  id: 'monthsBeforeNow',
  category: TEMPORAL_CATEGORY,
  exec: (months: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).minus({months}).toISO(),
...
export const monthsBeforeNowTrunc: CustomFunction = {
  ...
  category: TEMPORAL_CATEGORY,
  exec: (months: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).minus({months}).startOf('day').toISO(),
...
export const yearsBeforeNow: CustomFunction = {
  id: 'yearsBeforeNow',
  category: TEMPORAL_CATEGORY,
  exec: (years: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).minus({years}).toISO(),
...
export const yearsBeforeNowTrunc: CustomFunction = {
  ...
  category: TEMPORAL_CATEGORY,
  exec: (years: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).minus({years}).startOf('day').toISO(),
...
export const minutesAfterNow: CustomFunction = {
  id: 'minutesAfterNow',
  category: TEMPORAL_CATEGORY,
  exec: (minutes: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).plus({minutes}).toISO(),
...
export const hoursAfterNow: CustomFunction = {
  id: 'hoursAfterNow',
  category: TEMPORAL_CATEGORY,
  exec: (hours: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).plus({hours}).toISO(),
...
export const daysAfterNow: CustomFunction = {
  id: 'daysAfterNow',
  category: TEMPORAL_CATEGORY,
  exec: (days: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).plus({days}).toISO(),
...
export const weeksAfterNow: CustomFunction = {
  id: 'weeksAfterNow',
  category: TEMPORAL_CATEGORY,
  exec: (weeks: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).plus({weeks}).toISO(),
...
export const weeksAfterNowTrunc: CustomFunction = {
  ...
  category: TEMPORAL_CATEGORY,
  exec: (weeks: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).plus({weeks}).startOf('day').toISO(),
...
export const monthsAfterNow: CustomFunction = {
  id: 'monthsAfterNow',
  category: TEMPORAL_CATEGORY,
  exec: (months: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).plus({months}).toISO(),
...
export const monthsAfterNowTrunc: CustomFunction = {
  ...
  category: TEMPORAL_CATEGORY,
  exec: (months: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).plus({months}).startOf('day').toISO(),
...
export const yearsAfterNow: CustomFunction = {
  id: 'yearsAfterNow',
  category: TEMPORAL_CATEGORY,
  exec: (years: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).plus({years}).toISO(),
...
export const yearsAfterNowTrunc: CustomFunction = {
  ...
  category: TEMPORAL_CATEGORY,
  exec: (years: number) => DateTime.now().setZone(UTC, {keepLocalTime: true}).plus({years}).startOf('day').toISO(),
