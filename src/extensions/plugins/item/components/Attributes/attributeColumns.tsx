...
export const getAttributeColumns = (core: boolean, defaultColWidth: number): ColumnDef<NamedAttribute, any>[] =>
  [
...
export const getHiddenAttributeColumns = () =>
  ['enumSet', 'seqName', 'confirm', 'encode', 'relType', 'target', 'intermediate', 'mappedBy', 'inversedBy', 'referencedBy', 'keyed']