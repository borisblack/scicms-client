...
export default function AreaDash({dataset, dash, data, onDashClick}: DashRenderContext) {
  ...
  const {legendPosition, hideLegend, xAxisLabelAutoRotate, rules} = optValues
